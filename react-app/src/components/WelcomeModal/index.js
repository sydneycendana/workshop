    ...
    <div className="welcome-modal-container">
      <div className="welcome-modal-text-wrapper">
        ...
        <p>
          ...
          Upon relocating to a new city and transitioning to remote work, I
          faced the task of discovering suitable places to work and study
          efficiently. While I experimented with various options, I discovered
          that Yelp offered a partial solution; however, it wasn't specifically
          tailored to help find conducive workspaces.
        </p>
        <h3>How to use:</h3>
        <p>
        ...
        <div className="personal-links">
          ...
          <div className="portfolio-link">
            <a href="https://www.sydneycendana.com/" target="_blank">
              <img src={portfolio} alt="Portfolio" style={{ width: "300px" }} />
            </a>
          </div>
        </div>
      </div>
